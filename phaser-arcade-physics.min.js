...
(function() {
    ...
    b.WEBGL_RENDERER = 0, b.CANVAS_RENDERER = 1, b.VERSION = "v2.2.8", b._UID = 0, "undefined" != typeof Float32Array ? (b.Float32Array = Float32Array, b.Uint16Array = Uint16Array, b.Uint32Array = Uint32Array, b.ArrayBuffer = ArrayBuffer) : (b.Float32Array = Array, b.Uint16Array = Array), b.PI_2 = 2 * Math.PI, b.RAD_TO_DEG = 180 / Math.PI, b.DEG_TO_RAD = Math.PI / 180, b.RETINA_PREFIX = "@2x", b.defaultRenderOptions = {
        ...
        this.texture = a, this.texture.valid = !0
        ...
        if (!(this.visible === !1 || 0 === this.alpha || this.renderable === !1 || this.texture.crop.width <= 0 || this.texture.crop.height <= 0)) {
            ...
            if (c && (d = c), this.blendMode !== a.currentBlendMode && (a.currentBlendMode = this.blendMode, a.context.globalCompositeOperation = b.blendModesCanvas[a.currentBlendMode]), this._mask && a.maskManager.pushMask(this._mask, a), this.texture.valid) {
                ...
                a.roundPixels ? (a.context.setTransform(d.a, d.b, d.c, d.d, d.tx * a.resolution | 0, d.ty * a.resolution | 0), f = 0 | f, g = 0 | g) : a.context.setTransform(d.a, d.b, d.c, d.d, d.tx * a.resolution, d.ty * a.resolution);
        ...
        if (f.globalCompositeOperation = "multiply", f.drawImage(c, 0, 0), f.drawImage(d, 2, 0), !f.getImageData(2, 0, 1, 1)) return !1;
        ...
        var d = a.tintedTexture || document.createElement("canvas");
    ...
    }, b.CanvasTinter.canHandleAlpha = b.CanvasTinter.checkInverseAlpha(), b.CanvasTinter.canUseMultiply = b.canUseNewCanvasBlendModes(), b.CanvasTinter.tintMethod = b.CanvasTinter.canUseMultiply ? b.CanvasTinter.tintWithMultiply : b.CanvasTinter.tintWithPerPixel, b.CanvasRenderer = function(a, c, d) {
        if (d)
            for (var e in b.defaultRenderOptions) "undefined" == typeof d[e] && (d[e] = b.defaultRenderOptions[e]);
        else d = b.defaultRenderOptions;
        ...
        (a instanceof Phaser.Polygon || a instanceof b.Polygon) && (a = a.points);
        var c = a;
        if (!Array.isArray(c)) {
            c = new Array(arguments.length);
            for (var d = 0; d < c.length; ++d) c[d] = arguments[d]
        }
        return this.drawShape(new Phaser.Polygon(c)), this
        ...
        this.currentPath && this.currentPath.shape.points.length <= 2 && this.graphicsData.pop(), this.currentPath = null, a instanceof Phaser.Polygon && (a = a.clone(), a.flatten());
        ...
        if (this.visible !== !1 && 0 !== this.alpha) {
            ...
            var i = -g.x,
                ...
                k = this._width / h.x,
                l = this._height / h.y;
            a.roundPixels, c.fillRect(i, j, k, l), c.scale(1 / h.x, 1 / h.y), c.translate(-g.x + this.anchor.x * this._width, -g.y + this.anchor.y * this._height), this._mask && a.maskManager.popMask(a);
        ...
        if (this.valid && 0 !== a.alpha) {
            b.translate(0, 2 * this.projection.y), b.scale(1, -1);
            for (var d = 0; d < a.children.length; d++) a.children[d].updateTransform();
            var e = this.renderer.gl;
            e.viewport(0, 0, this.width * this.resolution, this.height * this.resolution), e.bindFramebuffer(e.FRAMEBUFFER, this.textureBuffer.frameBuffer), c && this.textureBuffer.clear(), this.renderer.spriteBatch.dirty = !0, this.renderer.renderDisplayObject(a, this.projection, this.textureBuffer.frameBuffer, b), this.renderer.spriteBatch.dirty = !0
        }
        ...
        if (this.valid && 0 !== a.alpha) {
            ...
            this.renderer.resolution = this.resolution, this.renderer.renderDisplayObject(a, this.textureBuffer.context, b), this.renderer.resolution = e
        }
    ...
    function() {
        ...
        window.console || (window.console = {}, window.console.log = window.console.assert = function() {}, window.console.warn = window.console.assert = function() {}), c.Utils = {
            ...
            rotate: function(a, b) {
                var c = this.start.x,
                    d = this.start.y;
                return this.start.rotate(this.end.x, this.end.y, a, b, this.length), this.end.rotate(c, d, a, b, this.length), this
            },
            ...
            clone: function(a) {
                return "undefined" == typeof a || null === a ? a = new c.Matrix(this.a, this.b, this.c, this.d, this.tx, this.ty) : (a.a = this.a, a.b = this.b, a.c = this.c, a.d = this.d, a.tx = this.tx, a.ty = this.ty), a
            },
            copyTo: function(a) {
            ...
            toArray: function(a, b) {
                return "undefined" == typeof b && (b = new PIXI.Float32Array(9)), a ? (b[0] = this.a, b[1] = this.b, b[2] = 0, b[3] = this.c, b[4] = this.d, b[5] = 0, b[6] = this.tx, b[7] = this.ty, b[8] = 1) : (b[0] = this.a, b[1] = this.c, b[2] = this.tx, b[3] = this.b, b[4] = this.d, b[5] = this.ty, b[6] = 0, b[7] = 0, b[8] = 1), b
            },
            apply: function(a, b) {
                return "undefined" == typeof b && (b = new c.Point), b.x = this.a * a.x + this.c * a.y + this.tx, b.y = this.b * a.x + this.d * a.y + this.ty, b
            },
            ...
            "undefined" == typeof f && (f = !1), "undefined" == typeof g && (g = null), f && (e = c.Math.degToRad(e)), null === g && (g = Math.sqrt((b - a.x) * (b - a.x) + (d - a.y) * (d - a.y)));
            var h = e + Math.atan2(a.y - d, a.x - b);
            return a.x = b + g * Math.cos(h), a.y = d + g * Math.sin(h), a
            ...
            random: function(a) {
                return "undefined" == typeof a && (a = new c.Point), a.x = this.randomX, a.y = this.randomY, a
            },
            toString: function() {
            ...
            this.game = a, this.bmd = a.make.bitmapData(), this.canvas = this.bmd.canvas, this.ctx = this.bmd.context, this.palettes = [{
                0: "#000",
                1: "#9D9D9D",
                2: "#FFF",
                3: "#BE2633",
            ...
            texture: function(a, b, c, d, e) {
                "undefined" == typeof c && (c = 8), "undefined" == typeof d && (d = c), "undefined" == typeof e && (e = 0);
                var f = b[0].length * c,
                    g = b.length * d;
            ...
            return "undefined" == typeof b && (b = !1), a.parent !== this && (this.addChild(a), a.z = this.children.length, this.enableBody && null === a.body ? this.game.physics.enable(a, this.physicsBodyType) : a.body && this.addToHash(a), !b && a.events && a.events.onAddedToGroup$dispatch(a, this), null === this.cursor && (this.cursor = a)), a
            ...
            return "undefined" == typeof c && (c = !1), a.parent !== this && (this.addChildAt(a, b), this.updateZ(), this.enableBody && null === a.body ? this.game.physics.enable(a, this.physicsBodyType) : a.body && this.addToHash(a), !c && a.events && a.events.onAddedToGroup$dispatch(a, this), null === this.cursor && (this.cursor = a)), a
            ...
            if ("undefined" == typeof b && (b = !1), this.children.length > 0 && a instanceof c.Group) {
            ...
            boot: function() {
                ...
                }, document.addEventListener("webkitfullscreenchange", this._fullScreenChange, !1), document.addEventListener("mozfullscreenchange", this._fullScreenChange, !1), document.addEventListener("MSFullscreenChange", this._fullScreenChange, !1), document.addEventListener("fullscreenchange", this._fullScreenChange, !1), document.addEventListener("webkitfullscreenerror", this._fullScreenError, !1), document.addEventListener("mozfullscreenerror", this._fullScreenError, !1), document.addEventListener("MSFullscreenError", this._fullScreenError, !1), document.addEventListener("fullscreenerror", this._fullScreenError, !1)), this.game.onResume.add(this._gameResumed, this), this.dom.getOffset(this.game.canvas, this.offset), this.bounds.setTo(this.offset.x, this.offset.y, this.width, this.height), this.setGameSize(this.game.width, this.game.height), this.screenOrientation = this.dom.getScreenOrientation(this.compatibility.orientationFallback), this.grid = new c.FlexGrid(this, this.width, this.height), this._booted = !0, this._pendingScaleMode && (this.scaleMode = this._pendingScaleMode, this._pendingScaleMode = null)
            },
            ...
            scaleSprite: function(a, b, c, d) {
                if ("undefined" == typeof b && (b = this.width), "undefined" == typeof c && (c = this.height), "undefined" == typeof d && (d = !1), !a || !a.scale) return a;
            ...
            boot: function() {
                this.mousePointer = new c.Pointer(this.game, 0), this.addPointer(), this.addPointer(), this.mouse = new c.Mouse(this.game), this.touch = new c.Touch(this.game), this.mspointer = new c.MSPointer(this.game), c.Keyboard && (this.keyboard = new c.Keyboard(this.game)), c.Gamepad && (this.gamepad = new c.Gamepad(this.game)), this.onDown = new c.Signal, this.onUp = new c.Signal, this.onTap = new c.Signal, this.onHold = new c.Signal, this.scale = new c.Point(1, 1), this.speed = new c.Point, this.position = new c.Point, this._oldPosition = new c.Point, this.circle = new c.Circle(0, 0, 44), this.activePointer = this.mousePointer, this.hitCanvas = document.createElement("canvas"), this.hitCanvas.width = 1, this.hitCanvas.height = 1, this.hitContext = this.hitCanvas.getContext("2d"), this.mouse.start(), this.touch.start(), this.mspointer.start(), this.mousePointer.active = !0, this.keyboard && this.keyboard.start();
                var a = this;
            ...
            resetButtons: function() {
                this.leftButton = !1, this.middleButton = !1, this.rightButton = !1, this.backButton = !1, this.forwardButton = !1, this.eraserButton = !1
            },
            updateButtons: function(a) {
                var b = a.buttons;
                "undefined" != typeof b && (this.leftButton = c.Pointer.LEFT_BUTTON & b ? !0 : !1, this.rightButton = c.Pointer.RIGHT_BUTTON & b ? !0 : !1, this.middleButton = c.Pointer.MIDDLE_BUTTON & b ? !0 : !1, this.backButton = c.Pointer.BACK_BUTTON & b ? !0 : !1, this.forwardButton = c.Pointer.FORWARD_BUTTON & b ? !0 : !1, this.eraserButton = c.Pointer.ERASER_BUTTON & b ? !0 : !1, a.ctrlKey && this.leftButton && (this.rightButton = !0))
            },
            start: function(a) {
                return a.pointerId && (this.pointerId = a.pointerId), this.identifier = a.identifier, this.target = a.target, this.updateButtons(a), this._history = [], this.active = !0, this.withinGame = !0, this.isDown = !0, this.isUp = !1, this.dirty = !1, this._clickTrampolines = null, this._trampolineTargetObject = null, this.msSinceLastClick = this.game.time.time - this.timeDown, this.timeDown = this.game.time.time, this._holdSent = !1, this.move(a, !0), this.positionDown.setTo(this.x, this.y), (this.game.input.multiInputOverride === c.Input.MOUSE_OVERRIDES_TOUCH || this.game.input.multiInputOverride === c.Input.MOUSE_TOUCH_COMBINE || this.game.input.multiInputOverride === c.Input.TOUCH_OVERRIDES_MOUSE && 0 === this.game.input.totalActivePointers) && (this.game.input.x = this.x, this.game.input.y = this.y, this.game.input.position.setTo(this.x, this.y), this.game.input.onDown.dispatch(this, a), this.game.input.resetSpeed(this.x, this.y)), this._stateReset = !1, this.totalTouches++, null !== this.targetObject && this.targetObject._touchedHandler(this), this
            },
            update: function() {
            ...
            reset: function() {
                this.isMouse === !1 && (this.active = !1), this.pointerId = null, this.identifier = null, this.dirty = !1, this.isDown = !1, this.isUp = !0, this.totalTouches = 0, this._holdSent = !1, this._history.length = 0, this._stateReset = !0, this.resetButtons(), this.targetObject && this.targetObject._releasedHandler(this), this.targetObject = null
            },
        ...
        c.Component.FixedToCamera = function() {}, c.Component.FixedToCamera.postUpdate = function() {
            ...
            loadTexture: function(a, b, d) {
                b = b || 0, (d || "undefined" == typeof d) && this.animations && this.animations.stop(), this.key = a, this.customRender = !1;
                var e = !0,
                    f = !this.texture.baseTexture.scaleMode;
                if (c.RenderTexture && a instanceof c.RenderTexture) this.key = a.key, this.setTexture(a);
                else if (c.BitmapData && a instanceof c.BitmapData) this.customRender = !0, this.setTexture(a.texture), this.game.cache.getFrameData(a.key, c.Cache.BITMAPDATA) && (e = !this.animations.loadFrameData(this.game.cache.getFrameData(a.key, c.Cache.BITMAPDATA), b));
                else if (c.Video && a instanceof c.Video) {
                    this.customRender = !0;
                    var g = a.texture.valid;
                    this.setTexture(a.texture), this.setFrame(a.texture.frame.clone()), a.onChangeSource.add(this.resizeFrame, this), this.texture.valid = g
                } else a instanceof PIXI.Texture ? this.setTexture(a) : null === a || "undefined" == typeof a ? (this.key = "__default", this.setTexture(PIXI.TextureCache[this.key])) : "string" != typeof a || this.game.cache.checkImageKey(a) ? (this.setTexture(new PIXI.Texture(PIXI.BaseTextureCache[a])), e = !this.animations.loadFrameData(this.game.cache.getFrameData(a), b)) : (console.warn("Texture with key '" + a + "' not found."), this.key = "__missing", this.setTexture(PIXI.TextureCache[this.key]));
                e && (this._frame = c.Rectangle.clone(this.texture.frame)), f || (this.texture.baseTexture.scaleMode = 1)
            },
            setFrame: function(a) {
            ...
            b = b || 0, d = d || 0, e = e || 256, f = f || 256, g = g || null, h = h || null, this.type = c.TILESPRITE, this.physicsType = c.SPRITE, this._scroll = new c.Point, PIXI.TilingSprite.call(this, PIXI.TextureCache.__default, e, f), c.Component.Core.init.call(this, a, b, d, g, h)
            ...
            this.points = [], this.points = g, this._hasUpdateAnimation = !1, this._updateAnimationCallback = null, b = b || 0, d = d || 0, e = e || null, f = f || null, this.type = c.ROPE, this._scroll = new c.Point, PIXI.Rope.call(this, PIXI.TextureCache.__default, this.points), c.Component.Core.init.call(this, a, b, d, e, f)
        ...
        c.Button.prototype.clearFrames = function() {
            ...
            ("undefined" == typeof d || 0 === d) && (d = 256), ("undefined" == typeof e || 0 === e) && (e = 256), this.game = a, this.key = b, this.width = d, this.height = e, this.canvas = c.Canvas.create(d, e, "", !0), this.context = this.canvas.getContext("2d", {
                alpha: !0
                ...
                prev: 1,
                current: 1
            }, this._anchor = new c.Point, this._tempR = 0, this._tempG = 0, this._tempB = 0, this._circle = new c.Circle, this._swapCanvas = c.Canvas.create(d, e, "", !0)
            ...
            clear: function(a, b, c, d) {
                return "undefined" == typeof a && (a = 0), "undefined" == typeof b && (b = 0), "undefined" == typeof c && (c = this.width), "undefined" == typeof d && (d = this.height), this.context.clearRect(a, b, c, d), this.dirty = !0, this
            },
            ...
            generateTexture: function(a) {
                var b = new Image;
                return b.src = this.canvas.toDataURL("image/png"), this.game.cache.addImage(a, "", b), new PIXI.Texture(PIXI.BaseTextureCache[a])
            },
            resize: function(a, b) {
            ...
            "undefined" == typeof b && (b = 0), "undefined" == typeof d && (d = 0), this.type = c.GRAPHICS, this.physicsType = c.SPRITE, PIXI.Graphics.call(this), c.Component.Core.init.call(this, a, b, d, "", null)
            ...
            "undefined" == typeof e && (e = ""), "undefined" == typeof f && (f = c.scaleModes.DEFAULT), "undefined" == typeof g && (g = 1), this.game = a, this.key = e, this.type = c.RENDERTEXTURE, this._tempMatrix = new PIXI.Matrix, PIXI.RenderTexture.call(this, b, d, this.game.renderer, f, g), this.render = c.RenderTexture.prototype.render
            ...
            return "undefined" == typeof a && (a = 0), "undefined" == typeof b && (b = 0), "undefined" == typeof c && (c = "rgba(0, 0, 0, 1)"), "undefined" == typeof d && (d = 0), "undefined" == typeof e && (e = !0), "undefined" == typeof f && (f = !0), this.style.shadowOffsetX = a, this.style.shadowOffsetY = b, this.style.shadowColor = c, this.style.shadowBlur = d, this.style.shadowStroke = e, this.style.shadowFill = f, this.dirty = !0, this
            ...
            var r, s;
            for (this._charCount = 0, g = 0; g < b.length; g++) r = this.style.strokeThickness / 2, s = this.style.strokeThickness / 2 + g * o + f.ascent, g > 0 && (s += q * g), "right" === this.style.align ? r += e - d[g] : "center" === this.style.align && (r += (e - d[g]) / 2), this.autoRound && (r = Math.round(r), s = Math.round(s)), this.colors.length > 0 || this.strokeColors.length > 0 ? this.updateLine(b[g], r, s) : (this.style.stroke && this.style.strokeThickness && (this.updateShadow(this.style.shadowStroke), 0 === c ? this.context.strokeText(b[g], r, s) : this.renderTabLine(b[g], r, s, !1)), this.style.fill && (this.updateShadow(this.style.shadowFill), 0 === c ? this.context.fillText(b[g], r, s) : this.renderTabLine(b[g], r, s, !0)));
            this.updateTexture()
            ...
            return "undefined" == typeof a ? this.textBounds = null : (this.textBounds ? this.textBounds.setTo(a, b, d, e) : this.textBounds = new c.Rectangle(a, b, d, e), this.style.wordWrapWidth > d && (this.style.wordWrapWidth = d)), this.updateTexture(), this
            ...
            var a = PIXI.BitmapText.fonts[this._font];
            if (a) {
                var b = this.text,
                ...
                for (var g = 0, h = 0, i = this.textWidth * this.anchor.x, j = this.textHeight * this.anchor.y, k = 0; k < d.length; k++) {
                    ...
                    for (var l = 0; l < f.text.length; l++) {
                        var m = f.text.charCodeAt(l),
                            n = a.chars[m],
                            o = this._glyphs[g];
                        o ? o.texture = n.texture : (o = new PIXI.Sprite(n.texture), o.name = f.text[l], this._glyphs.push(o)), o.position.x = f.chars[l] + h - i, o.position.y = f.y + n.yOffset * c - j, o.scale.set(c), o.tint = this.tint, o.parent || this.addChild(o), g++
                    }
                }
            ...
            set: function(a) {
                a !== this._font && (this._font = a.trim(), this.updateText())
            }
            ...
            function a() {
                ...
                /Playstation Vita/.test(a) ? l.vita = !0 : /Kindle/.test(a) || /\bKF[A-Z][A-Z]+/.test(a) || /Silk.*Mobile Safari/.test(a) ? l.kindle = !0 : /Android/.test(a) ? l.android = !0 : /CrOS/.test(a) ? l.chromeOS = !0 : /iP[ao]d|iPhone/i.test(a) ? l.iOS = !0 : /Linux/.test(a) ? l.linux = !0 : /Mac OS/.test(a) ? l.macOS = !0 : /Windows/.test(a) && (l.windows = !0), (/Windows Phone/i.test(a) || /IEMobile/i.test(a)) && (l.android = !1, l.iOS = !1, l.macOS = !1, l.windows = !0, l.windowsPhone = !0);
                var b = /Silk/.test(a);
            ...
            return "webm" === a && (this.webmVideo || this.vp9Video) ? !0 : "mp4" === a && (this.mp4Video || this.h264Video) ? !0 : "ogg" === a && this.oggVideo ? !0 : "mpeg" === a && this.hlsVideo ? !0 : !1
        ...
        c.Math.degToRad = function(a) {
            ...
            generateData: function(a, b) {
                ...
                "undefined" == typeof a && (a = 60), "undefined" == typeof b && (b = []);
            ...
            updateCurrentFrame: function(a, b) {
                if ("undefined" == typeof b && (b = !1), !this._frameData) return !1;
                if (b) this.currentFrame = this._frameData.getFrame(this._frames[this._frameIndex]), this.currentFrame && this._parent.setFrame(this.currentFrame);
                else {
                    var c = this.currentFrame.index;
                    this.currentFrame = this._frameData.getFrame(this._frames[this._frameIndex]), this.currentFrame && c !== this.currentFrame.index && this._parent.setFrame(this.currentFrame)
                }
            ...
            getFrames: function(a, b, c) {
                if ("undefined" == typeof b && (b = !0), "undefined" == typeof c && (c = []), "undefined" == typeof a || 0 === a.length)
                    ...
                    for (var d = 0; d < a.length; d++) c.push(b ? this.getFrame(a[d]) : this.getFrameByName(a[d]));
                return c
            },
        ...
        }, c.Cache.CANVAS = 1, c.Cache.IMAGE = 2, c.Cache.TEXTURE = 3, c.Cache.SOUND = 4, c.Cache.TEXT = 5, c.Cache.PHYSICS = 6, c.Cache.TILEMAP = 7, c.Cache.BINARY = 8, c.Cache.BITMAPDATA = 9, c.Cache.BITMAPFONT = 10, c.Cache.JSON = 11, c.Cache.XML = 12, c.Cache.VIDEO = 13, c.Cache.prototype = {
            ...
            addSpriteSheet: function(a, b, d, e, f, g, h, i) {
                this._images[a] = {
                    ...
                    margin: h,
                    spacing: i
                }, PIXI.BaseTextureCache[a] = new PIXI.BaseTexture(d), this._images[a].frameData = c.AnimationParser.spriteSheet(this.game, a, e, f, g, h, i), this._resolveURL(b, this._images[a])
            },
            ...
            addTextureAtlas: function(a, b, d, e, f) {
                this._images[a] = {
                    url: b,
                    data: d
                }, PIXI.BaseTextureCache[a] = new PIXI.BaseTexture(d), this._images[a].frameData = f == c.Loader.TEXTURE_ATLAS_XML_STARLING ? c.AnimationParser.XMLData(this.game, e, a) : Array.isArray(e.frames) ? c.AnimationParser.JSONData(this.game, e, a) : c.AnimationParser.JSONDataHash(this.game, e, a), this._resolveURL(b, this._images[a])
            },
            addBitmapFont: function(a, b, d, e, f, g, h) {
                this._images[a] = {
                    url: b,
                    data: d
                }, PIXI.BaseTextureCache[a] = new PIXI.BaseTexture(d), "json" === f ? c.LoaderParser.jsonBitmapFont(this.game, e, a, g, h) : c.LoaderParser.xmlBitmapFont(this.game, e, a, g, h), this._bitmapFont[a] = PIXI.BitmapText.fonts[a], this._resolveURL(b, this._bitmapFont[a])
            },
            ...
            addImage: function(a, b, d) {
                this.checkImageKey(a) && this.removeImage(a), this._images[a] = {
                    url: b,
                    data: d
                }, this._images[a].frame = new c.Frame(0, 0, 0, d.width, d.height, a), this._images[a].frameData = new c.FrameData, this._images[a].frameData.addFrame(new c.Frame(0, 0, 0, d.width, d.height, b)), PIXI.BaseTextureCache[a] = new PIXI.BaseTexture(d), this._resolveURL(b, this._images[a])
            },
            ...
            addVideo: function(a, b, c, d) {
                this._videos[a] = {
                    ...
                    isBlob: d,
                    locked: !0
                }, this._resolveURL(b, this._videos[a])
            },
            ...
            getPixiTexture: function(a) {
                return PIXI.TextureCache[a] ? PIXI.TextureCache[a] : (console.warn('Phaser.Cache.getPixiTexture: Invalid key: "' + a + '"'), null)
            },
            getPixiBaseTexture: function(a) {
                return PIXI.BaseTextureCache[a] ? PIXI.BaseTextureCache[a] : (console.warn('Phaser.Cache.getPixiBaseTexture: Invalid key: "' + a + '"'), null)
            },
            getSound: function(a) {
            ...
            getVideo: function(a) {
                return this._videos[a] ? this._videos[a] : (console.warn('Phaser.Cache.getVideo: Invalid key: "' + a + '"'), null)
            },
            ...
            getJSON: function(a, b) {
                return this._json[a] ? b ? c.Utils.extend(!0, this._json[a].data) : this._json[a].data : (console.warn('Phaser.Cache.getJSON: Invalid key: "' + a + '"'), null)
            },
            getXML: function(a) {
            ...
            destroy: function() {
                ...
                for (var b = [this._canvases, this._sounds, this._videos, this._text, this._json, this._xml, this._textures, this._physics, this._tilemaps, this._binary, this._bitmapDatas, this._bitmapFont], c = 0; c < b.length; c++)
            ...
            addToFileList: function(a, b, c, d, e, f) {
                if ("undefined" == typeof e && (e = !1), "undefined" == typeof b || "" === b) return console.warn("Phaser.Loader: Invalid or no key given of type " + a), this;
            ...
            script: function(a, b, c, d) {
                return "undefined" == typeof c && (c = !1), c !== !1 && "undefined" == typeof d && (d = this), this.addToFileList("script", a, b, {
                    syncPoint: !0,
                    callback: c,
                    callbackContext: d
                }, !1, ".js")
            ...
            audio: function(a, b, c) {
                return this.game.sound.noAudio ? this : ("undefined" == typeof c && (c = !0), "string" == typeof b && (b = [b]), this.addToFileList("audio", a, b, {
                    buffer: null,
                    autoDecode: c
                }))
            },
            audiosprite: function(a, b, c, d, e) {
                return this.game.sound.noAudio ? this : ("undefined" == typeof c && (c = null), "undefined" == typeof d && (d = null), "undefined" == typeof e && (e = !0), this.audio(a, b, e), c ? this.json(a + "-audioatlas", c) : d ? ("string" == typeof d && (d = JSON.parse(d)), this.game.cache.addJSON(a + "-audioatlas", "", d)) : console.warn("Phaser.Loader.audiosprite - You must specify either a jsonURL or provide a jsonData object"), this)
            },
            video: function(a, b, c, d) {
                return "undefined" == typeof c && (c = this.game.device.firefox ? "loadeddata" : "canplaythrough"), "undefined" == typeof d && (d = !1), "string" == typeof b && (b = [b]), this.addToFileList("video", a, b, {
                    buffer: null,
                    asBlob: d,
                    loadEvent: c
                })
            ...
            tilemap: function(a, b, d, e) {
                if ("undefined" == typeof b && (b = null), "undefined" == typeof d && (d = null), "undefined" == typeof e && (e = c.Tilemap.CSV), b || d || (b = e === c.Tilemap.CSV ? a + ".csv" : a + ".json"), d) {
                    switch (e) {
                        case c.Tilemap.CSV:
                            break;
            ...
            physics: function(a, b, d, e) {
                return "undefined" == typeof b && (b = null), "undefined" == typeof d && (d = null), "undefined" == typeof e && (e = c.Physics.LIME_CORONA_JSON), b || d || (b = a + ".json"), d ? ("string" == typeof d && (d = JSON.parse(d)), this.game.cache.addPhysicsData(a, null, d, e)) : this.addToFileList("physics", a, b, {
                    format: e
                }), this
            },
            bitmapFont: function(a, b, c, d, e, f) {
                if (("undefined" == typeof b || null === b) && (b = a + ".png"), "undefined" == typeof c && (c = null), "undefined" == typeof d && (d = null), "undefined" == typeof e && (e = 0), "undefined" == typeof f && (f = 0), c) this.addToFileList("bitmapfont", a, b, {
                    atlasURL: c,
                    xSpacing: e,
                    ySpacing: f
                });
            ...
            atlasXML: function(a, b, d, e) {
                return "undefined" == typeof d && (d = null), "undefined" == typeof e && (e = null), d || e || (d = a + ".xml"), this.atlas(a, b, d, e, c.Loader.TEXTURE_ATLAS_XML_STARLING)
            },
            atlas: function(a, b, d, e, f) {
                if (("undefined" == typeof b || null === b) && (b = a + ".png"), "undefined" == typeof d && (d = null), "undefined" == typeof e && (e = null), "undefined" == typeof f && (f = c.Loader.TEXTURE_ATLAS_JSON_ARRAY), d || e || (d = f === c.Loader.TEXTURE_ATLAS_XML_STARLING ? a + ".xml" : a + ".json"), d) this.addToFileList("textureatlas", a, b, {
                    atlasURL: d,
                    format: f
                });
                else {
            ...
            transformUrl: function(a) {
                return a ? "http" === a.substr(0, 4) || "//" === a.substr(0, 2) ? a : this.baseURL + a : !1
            },
            loadFile: function(a) {
                switch (a.type) {
                    case "packfile":
            ...
            fileComplete: function(a, b) {
                ...
                switch (a.type) {
                    ...
                    case "bitmapfont":
                        ...
                        })) : this.game.cache.addBitmapFont(a.key, a.url, a.data, a.atlasData, a.atlasType, a.xSpacing, a.ySpacing);
                        break;
                    case "video":
                        if (a.asBlob) try {
                        ...
                        this.game.cache.addVideo(a.key, a.url, a.data, a.asBlob);
                        break;
                    case "audio":
            ...
            jsonLoadComplete: function(a, b) {
                ...
                "tilemap" === a.type ? this.game.cache.addTilemap(a.key, a.url, c, a.format) : "bitmapfont" === a.type ? this.game.cache.addBitmapFont(a.key, a.url, a.data, c, a.atlasType, a.xSpacing, a.ySpacing) : "json" === a.type ? this.game.cache.addJSON(a.key, a.url, c) : this.game.cache.addTextureAtlas(a.key, a.url, a.data, c, a.format), this.asyncComplete(a)
            },
            ...
            xmlLoadComplete: function(a, b) {
                ...
                "bitmapfont" === a.type ? this.game.cache.addBitmapFont(a.key, a.url, a.data, d, a.atlasType, a.xSpacing, a.ySpacing) : "textureatlas" === a.type ? this.game.cache.addTextureAtlas(a.key, a.url, a.data, d, a.format) : "xml" === a.type && this.game.cache.addXML(a.key, a.url, d), this.asyncComplete(a)
            },
            parseXml: function(a) {
                var b;
                try {
            ...
            bitmapFont: function(a, b, c, d, e) {
                this.xmlBitmapFont(a, b, c, d, e)
            },
            xmlBitmapFont: function(a, b, c, d, e) {
                var f = {},
                ...
                for (var i = b.getElementsByTagName("char"), j = 0; j < i.length; j++) {
                    ...
                    f.chars[k] = {
                        x: parseInt(i[j].getAttribute("x"), 10),
                        y: parseInt(i[j].getAttribute("y"), 10),
                        width: parseInt(i[j].getAttribute("width"), 10),
                        height: parseInt(i[j].getAttribute("height"), 10),
                ...
                var l = b.getElementsByTagName("kerning");
                for (j = 0; j < l.length; j++) {
                    var m = parseInt(l[j].getAttribute("first"), 10),
                        n = parseInt(l[j].getAttribute("second"), 10),
                        o = parseInt(l[j].getAttribute("amount"), 10);
                    f.chars[n].kerning[m] = o
                }
                this.finalizeBitmapFont(c, f)
            },
            jsonBitmapFont: function(a, b, c, d, e) {
                var f = {
                    font: b.font.info._font,
                    size: parseInt(b.font.info._size, 10),
                    lineHeight: parseInt(b.font.common._lineHeight, 10) + e,
                    chars: {}
                };
                b.font.chars["char"].forEach(function(a) {
                    ...
                    f.chars[b] = {
                        ...
                        xAdvance: parseInt(a._xadvance, 10) + d,
                        kerning: {}
                    }
                }), b.font.kernings.kerning.forEach(function(a) {
                    f.chars[a._second].kerning[a._first] = parseInt(a._amount, 10)
                }), this.finalizeBitmapFont(c, f)
            },
            finalizeBitmapFont: function(a, b) {
                Object.keys(b.chars).forEach(function(c) {
                    var d = b.chars[c],
                        e = new PIXI.Rectangle(d.x, d.y, d.width, d.height);
                    d.texture = new PIXI.Texture(PIXI.BaseTextureCache[a], e)
                }), PIXI.BitmapText.fonts[a] = b
            }
            ...
            addMarker: function(a, b, c, d, e) {
                ("undefined" == typeof d || null === d) && (d = 1), "undefined" == typeof e && (e = !1), this.markers[a] = {
                    name: a,
                    start: b,
                    stop: b + c,
                    volume: d,
            ...
            play: function(a, b, c, d, e) {
                ...
                if (this._sound && this.isPlaying && !this.allowMultiple && (this.override || e))
                    if (this.usingWebAudio)
                        if (this._sound.disconnect(this.externalNode ? this.externalNode : this.gainNode), "undefined" == typeof this._sound.stop) this._sound.noteOff(0);
                        else try {
                            this._sound.stop(0)
            ...
            resume: function() {
                if (this.paused && this._sound) {
                    if (this.usingWebAudio) {
                        ...
                        "undefined" == typeof this._sound.start ? this._sound.noteGrainOn(0, a, b) : this.loop && this.game.device.chrome ? 42 === this.game.device.chromeVersion ? this._sound.start(0) : this._sound.start(0, a) : this._sound.start(0, a, b)
            ...
            boot: function() {
                ...
                if (window.PhaserGlobal && window.PhaserGlobal.audioContext) this.context = window.PhaserGlobal.audioContext;
                    ...
                    } else this.usingWebAudio = !0, this.masterGain = "undefined" == typeof this.context.createGain ? this.context.createGainNode() : this.context.createGain(), this.masterGain.gain.value = 1, this.masterGain.connect(this.context.destination);
            ...
            enable: function(a, b, d) {
                "undefined" == typeof b && (b = c.Physics.ARCADE), "undefined" == typeof d && (d = !1), b === c.Physics.ARCADE ? this.arcade.enable(a) : b === c.Physics.P2JS && this.p2 ? this.p2.enable(a, d) : b === c.Physics.NINJA && this.ninja ? this.ninja.enableAABB(a) : b === c.Physics.BOX2D && this.box2d ? this.box2d.enable(a) : b === c.Physics.MATTERJS && this.matter && this.matter.enable(a)
            },
            preUpdate: function() {
        ...
        }, c.Utils.mixinPrototype(c.Physics.Arcade.prototype, c.Physics.Arcade.TilemapCollision.prototype), c.ImageCollection = function(a, b, c, d, e, f, g) {
            ("undefined" == typeof c || 0 >= c) && (c = 32), ("undefined" == typeof d || 0 >= d) && (d = 32), "undefined" == typeof e && (e = 0), "undefined" == typeof f && (f = 0), this.name = a, this.firstgid = 0 | b, this.imageWidth = 0 | c, this.imageHeight = 0 | d, this.imageMargin = 0 | e, this.imageSpacing = 0 | f, this.properties = g || {}, this.images = [], this.total = 0
            ...
            addTilesetImage: function(a, b, d, e, f, g, h) {
                ...
                "undefined" == typeof d && (d = this.tileWidth), "undefined" == typeof e && (e = this.tileHeight), "undefined" == typeof f && (f = 0), "undefined" == typeof g && (g = 0), "undefined" == typeof h && (h = 0), 0 === d && (d = 32), 0 === e && (e = 32);
                var i = null;
                if (("undefined" == typeof b || null === b) && (b = a), b instanceof c.BitmapData) i = b.canvas;
                else {
            ...
            createFromObjects: function(a, b, d, e, f, g, h, i, j) {
                ...
                for (var k, l = !1, m = 0, n = this.objects[a].length; n > m; m++)
                    if ("undefined" != typeof this.objects[a][m].gid && "number" == typeof b && this.objects[a][m].gid === b && (l = !0), "undefined" != typeof this.objects[a][m].id && "number" == typeof b && this.objects[a][m].id === b && (l = !0), "undefined" != typeof this.objects[a][m].name && "string" == typeof b && this.objects[a][m].name === b && (l = !0), l) {
                        k = new i(this.game, this.objects[a][m].x, this.objects[a][m].y, d, e), k.name = this.objects[a][m].name, k.visible = this.objects[a][m].visible, k.autoCull = g, k.exists = f, k.width = this.objects[a][m].width, k.height = this.objects[a][m].height, this.objects[a][m].rotation && (k.angle = this.objects[a][m].rotation), j && (k.y -= k.height), h.add(k);
                        for (var o in this.objects[a][m].properties) h.set(k, o, this.objects[a][m].properties[o], !1, !1, 0, !0)
                    }
            },
            ...
            getTileWorldXY: function(a, b, c, d, e, f) {
                return "undefined" == typeof c && (c = this.tileWidth), "undefined" == typeof d && (d = this.tileHeight), e = this.getLayer(e), a = this.game.math.snapToFloor(a, c) / c, b = this.game.math.snapToFloor(b, d) / d, this.getTile(a, b, e, f)
            },
            ...
            e |= 0, f |= 0, c.Sprite.call(this, a, 0, 0), this.map = b, this.index = d, this.layer = b.layers[d], this.canvas = c.Canvas.create(e, f), this.context = this.canvas.getContext("2d"), this.setTexture(new PIXI.Texture(new PIXI.BaseTexture(this.canvas))), this.type = c.TILEMAPLAYER, this.physicsType = c.TILEMAPLAYER, this.renderSettings = {
                enableScrollDelta: !1,
                overdrawRatio: .2,
                copyCanvas: null
            ...
            parseTiledJSON: function(a) {
                ...
                d.images = q;
                for (var s = [], t = [], f = 0; f < a.tilesets.length; f++) {
                    var u = a.tilesets[f];
                    if (u.image) {
                        var v = new c.Tileset(u.name, u.firstgid, u.tilewidth, u.tileheight, u.margin, u.spacing, u.properties);
                        u.tileproperties && (v.tileProperties = u.tileproperties), v.updateTileData(u.imagewidth, u.imageheight), s.push(v)
                    } else {
                        var w = new c.ImageCollection(u.name, u.firstgid, u.tilewidth, u.tileheight, u.margin, u.spacing, u.properties);
                        for (var f in u.tiles) {
                            var r = u.tiles[f].image,
                ...
                d.tilesets = s, d.imagecollections = t;
                for (var x = {}, y = {}, f = 0; f < a.layers.length; f++)
                    if ("objectgroup" === a.layers[f].type) {
                        x[a.layers[f].name] = [], y[a.layers[f].name] = [];
                        for (var z = 0, p = a.layers[f].objects.length; p > z; z++)
                            if (a.layers[f].objects[z].gid) {
                                var A = {
                                    gid: a.layers[f].objects[z].gid,
                                    name: a.layers[f].objects[z].name,
                                    type: a.layers[f].objects[z].hasOwnProperty("type") ? a.layers[f].objects[z].type : "",
                                    x: a.layers[f].objects[z].x,
                                    y: a.layers[f].objects[z].y,
                                    visible: a.layers[f].objects[z].visible,
                                    properties: a.layers[f].objects[z].properties
                                };
                                a.layers[f].objects[z].rotation && (A.rotation = a.layers[f].objects[z].rotation), x[a.layers[f].name].push(A)
                            } else if (a.layers[f].objects[z].polyline) {
                            var A = {
                                name: a.layers[f].objects[z].name,
                                type: a.layers[f].objects[z].type,
                                x: a.layers[f].objects[z].x,
                                y: a.layers[f].objects[z].y,
                                width: a.layers[f].objects[z].width,
                                height: a.layers[f].objects[z].height,
                                visible: a.layers[f].objects[z].visible,
                                properties: a.layers[f].objects[z].properties
                            };
                            a.layers[f].objects[z].rotation && (A.rotation = a.layers[f].objects[z].rotation), A.polyline = [];
                            for (var B = 0; B < a.layers[f].objects[z].polyline.length; B++) A.polyline.push([a.layers[f].objects[z].polyline[B].x, a.layers[f].objects[z].polyline[B].y]);
                            y[a.layers[f].name].push(A), x[a.layers[f].name].push(A)
                        } else if (a.layers[f].objects[z].polygon) {
                            var A = b(a.layers[f].objects[z], ["name", "type", "x", "y", "visible", "rotation", "properties"]);
                            A.polygon = [];
                            for (var B = 0; B < a.layers[f].objects[z].polygon.length; B++) A.polygon.push([a.layers[f].objects[z].polygon[B].x, a.layers[f].objects[z].polygon[B].y]);
                            x[a.layers[f].name].push(A)
                        } else if (a.layers[f].objects[z].ellipse) {
                            var A = b(a.layers[f].objects[z], ["name", "type", "ellipse", "x", "y", "width", "height", "visible", "rotation", "properties"]);
                            x[a.layers[f].name].push(A)
                        } else {
                            var A = b(a.layers[f].objects[z], ["name", "type", "x", "y", "width", "height", "visible", "rotation", "properties"]);
                            A.rectangle = !0, x[a.layers[f].name].push(A)
                        }
                    }
                d.objects = x, d.collision = y, d.tiles = [];
                for (var f = 0; f < d.tilesets.length; f++)
                    for (var u = d.tilesets[f], l = u.tileMargin, C = u.tileMargin, D = 0, E = 0, F = 0, o = u.firstgid; o < u.firstgid + u.total && (d.tiles[o] = [l, C, f], l += u.tileWidth + u.tileSpacing, D++, D !== u.total) && (E++, E !== u.columns || (l = u.tileMargin, C += u.tileHeight + u.tileSpacing, E = 0, F++, F !== u.rows)); o++);
                for (var g, G, H, u, f = 0; f < d.layers.length; f++) {
                    g = d.layers[f];
                    for (var I = 0; I < g.data.length; I++) {
                        m = g.data[I];
                        for (var J = 0; J < m.length; J++) G = m[J], G.index < 0 || (H = d.tiles[G.index][2], u = d.tilesets[H], u.tileProperties && u.tileProperties[G.index - u.firstgid] && (G.properties = c.Utils.mixin(u.tileProperties[G.index - u.firstgid], G.properties)))
                    }
                }
                return d
            }
            ...
            startMediaStream: function(a, b, c) {
                if ("undefined" == typeof a && (a = !1), "undefined" == typeof b && (b = null), "undefined" == typeof c && (c = null), !this.game.device.getUserMedia) return this.onError.dispatch(this, "No getUserMedia"), !1;
                null !== this.videoStream && this.videoStream.stop(), this.removeVideoElement(), this.video = document.createElement("video"), this.video.setAttribute("autoplay", "autoplay"), null !== b && (this.video.width = b), null !== c && (this.video.height = c), this._timeOutID = window.setTimeout(this.getUserMediaTimeout.bind(this), this.timeout);
                try {
            ...
            changeSource: function(a, b) {
                return "undefined" == typeof b && (b = !0), this.texture.valid = !1, this.video.pause(), this.retry = this.retryLimit, this._retryID = window.setTimeout(this.checkVideoProgress.bind(this), this.retryInterval), this.video.src = a, this.video.load(), this._autoplay = b, b || (this.paused = !0), this
            },
            ...
            grab: function(a, b, c) {
                return "undefined" == typeof a && (a = !1), "undefined" == typeof b && (b = 1), "undefined" == typeof c && (c = null), null === this.snapshot ? void console.warn("Video.grab cannot run because Phaser.BitmapData is unavailable") : (a && this.snapshot.cls(), this.snapshot.copy(this.video, 0, 0, this.width, this.height, 0, 0, this.width, this.height, 0, 0, 0, 1, 1, b, c), this.snapshot)
            },
